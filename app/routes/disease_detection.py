...
@disease_bp.route("/download-report", methods=["POST"])
@login_required
def download_report():
    ...
    elements.append(Paragraph("<b>Crop Advisory System</b>", styles["Title"]))

    elements.append(Paragraph(f"<b>Crop:</b> {data['crop']}", styles["BodyText"]))

    elements.append(Paragraph(f"<b>Disease:</b> {data['disease']}", styles["BodyText"]))

    elements.append(Paragraph(f"<b>Confidence:</b> {data['confidence']}%", styles["BodyText"]))

    elements.append(Paragraph(f"<b>Severity:</b> {data['severity']}", styles["BodyText"]))

    elements.append(Paragraph(f"<b>Symptoms:</b> {data['symptoms']}", styles["BodyText"]))

    elements.append(Paragraph(f"<b>Causes:</b> {data['causes']}", styles["BodyText"]))

    elements.append(Paragraph(f"<b>Prevention:</b> {data['prevention']}", styles["BodyText"]))

    elements.append(Paragraph(f"<b>Treatment:</b> {data['treatment']}", styles["BodyText"]))
